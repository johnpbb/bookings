...
const ENQUIRY_TOURS: Record<string, { name: string; emoji: string; showWhaleAddon: boolean; price: string }> = {
  whale_charter:  { name: 'Whale Watch Charter',     emoji: '⚓', showWhaleAddon: false, price: 'Pricing on application' },
  island_charter: { name: 'Island Exclusive Charter', emoji: '🌴', showWhaleAddon: true,  price: 'TOP$ 2,400 (up to 10 people)' },
  game_fishing:   { name: 'Game Fishing Charter',    emoji: '🎣', showWhaleAddon: false, price: 'TOP$ 1,600 (up to 4 people)' },
}
...
export default function EnquiryPage() {
  ...
  const tour = ENQUIRY_TOURS[tourId]
  ...
  return (
    <div className="booking-shell">
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>{tour.price}</p>
      </div>
      ...
      <div className="step-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {tour.showWhaleAddon && isWhaleSeasonNow() && (
